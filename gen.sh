...
topojson --id-property su_a3 -p name --simplify-proportion .25 -o countries.topo.json countries.json
...
topojson --id-property postal -p name --simplify-proportion .5 -o states.topo.json states.json
